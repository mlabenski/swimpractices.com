<template>
  <div class="fixed z-10 inset-0 overflow-y-auto" v-if="seasons || mode === 'practice'">
    <div class="flex items-center justify-center min-h-screen">
      ...
      <div class="bg-white rounded-lg px2 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full sm:p-1 relative" style="width: 100%; max-width: 500px;">
